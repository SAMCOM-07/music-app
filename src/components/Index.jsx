...
const Index = () => {
  ...
  return (
    <div className="container mx-auto gridCenter">
      <div className="bg-[#050551] h-dvh w-screen md:h-[700px] md:w-[350px] md:shadow-3xl md:rounded-3xl relative flex flex-col items-center gap-4 p-4 overflow-hidden">
        <img
          src={Image}
          alt=""
